class PdfUaBuilder {
    ...
    #doc; // Type: PDFDocument from pdfkit
    ...
    setColorProfile() {
        ...
        const refColorProfile = this.#doc.ref({
        ...
        const refOutputIntent = this.#doc.ref({
            Type: 'OutputIntent',
            S: 'GTS_PDFA1',
        ...
        this.#doc._root.data.OutputIntents = [refOutputIntent];
    }
    ...
    setMetaData() {
        ...
        const refMetadata = this.#doc.ref({
        ...
        this.#doc._root.data.Metadata = refMetadata;
    }

    registerFont(fontName, src, family) {
        // PDF/A standard requires fonts to be embedded.
        this.#doc.registerFont(fontName, src, family);
    }
...
exports.createPdfUaBuilder = (doc) => {
    return new PdfUaBuilder(doc);
}
